        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlcholPresent = table.Column<double>(type: "float", nullable: false),
                    BottleCount = table.Column<int>(type: "int", nullable: false),
                    BottleHaveMililiter = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserWindowsWindowId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWindow", x => new { x.UserWindowsWindowId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_UserWindow_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UserWindow_Windows_UserWindowsWindowId",
                        column: x => x.UserWindowsWindowId,
